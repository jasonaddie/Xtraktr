#!/bin/sh
### BEGIN INIT INFO
# Provides:          Unicef-Data-Portal_unicorn_initialization
# Required-Start:    $remote_fs $syslog
# Required-Stop:     $remote_fs $syslog
# Default-Start:     2 3 4 5
# Default-Stop:      0 1 6
# Short-Description: Unicef-Data-Portal unicorn initialization
...
APP_ROOT=/home/deploy/Unicef-Data-Portal/current # path to application current folder
